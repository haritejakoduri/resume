...
import Container from '../../components/resume/container/container'
import Layout from '../../components/resume/layout/layout'
import Column from "../../components/resume/col/column"
import Profile from "../../components/resume/profile/profile"
import Contact from "../../components/resume/contact-info/contact"
import Headding from '../../components/resume/headding/headding'
import Details from '../../components/resume/details/details'
import Skill from '../../components/resume/skills/skills'
import './index.css'
function Resume(){
   return(<Container>
      <Layout>
      ...
      <Column name="right">
         ...
         <Details 
            ...
            text ="Working as a fullstack developer. Working with React and Express and mySQL."
         />
         <Details 
            company="Codegnan"
            role="FullStack Web Developer"
